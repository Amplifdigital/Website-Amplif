...
const Home = ({theme}) => {
  ...
  <div>
    ...
    <section className=" mission text-center mx-auto col-12">
      <h1 className='sub-header col-12 col-sm-8 mx-auto'> Our Mission is to Partner with digital-first businesses and fuel their growth with marketing strategies and advanced technology</h1>
    </section>
