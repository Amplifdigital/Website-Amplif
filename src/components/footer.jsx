          ...
          <div className="footer-logo-social">
            ...
            <div className="footer-social-outer destop-social">
              ...
              <div className="footer-social-icons">
                <Link to="https://x.com/amplifdigital?t=3MTGX8QNcfUtyuN8DzbOxg&s=08" className="footer-social-link"><img src={Twitter} alt="" title='' className='footer-social-img' /></Link>
                <Link to="https://www.instagram.com/amplifdigital?igsh=M2ZrZzNsM2J0eXVt" className="footer-social-link"><img src={Instagram} alt="" title='' className='footer-social-img' /></Link>
                ...
                <Link to="https://youtube.com/@amplifdigital" className="footer-social-link"><img src={Youtube} alt="" title='' className='footer-social-img' /></Link>
              </div>
            </div>
          </div>
          <div className="footer-quick-add-outer">
            ...
            <div className="footer-add-outer">
              ...
              <div className="footer-add-content">
                <a href="mailto:contact@amplifdigital.com" className="footer-add-links"><IoMdMail className='footer-add-icons'/>contact@amplifdigital.com</a><br /> 
                <Link to="" className="footer-add-links">
                <IoLocationSharp className='footer-add-icons'/>Boomit Technologies Pvt Ltd, Near Joggers Park, Borivali West, Mumbai, Maharashtra - 400092
                </Link><br /> 
